        ...
        <Box id='nav' bg={"#393e61"} w="full" h="6em" position={'fixed'} zIndex={1} >
          <Flex justify={"space-between"} align={'center'} h={'full'} color={'white'}>
            ...
            <Flex align='center' justify={'flex-end'} pr={'2%'} w={"50%"}>
              ...
              <Link href='https://drive.google.com/file/d/1GjHU0QQDCexpTD2Xg4P-THhm5kgroSlN/view?usp=sharing' style={{ textDecoration: "none" }}
          ...
          <Flex justify={'center'}>
            ...
            <VStack pt={'1em'} ml={'8em'}>
              ...
              <Flex justify={'center'} align={'center'} pt={'1em'}>
                ...
                <Link href="https://drive.google.com/file/d/1GjHU0QQDCexpTD2Xg4P-THhm5kgroSlN/view?usp=sharing">
